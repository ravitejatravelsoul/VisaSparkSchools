      ...
      <div aria-live="polite" className="text-sm">
        {status === "running" && (
          <p className="text-(--color-ink-muted)">
            Running your code… the first run on this page loads the Python runtime and can take a
            few seconds.
          </p>
        )}
        {status === "timeout" && (
          <p className="text-(--color-warning)">
            This is taking a long time — your code may have an infinite loop, or the Python runtime
            is slow to load on this connection. Click Stop, then try again.
          </p>
        )}
      </div>
