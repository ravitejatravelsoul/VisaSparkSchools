...
| P6.2 | PTE course content (>=12 lessons)                | in progress | delegated to a background content agent against the IELTS reference + schema                                                                                                                                                                                                                                                                                                               |
| P6.3 | TOEFL iBT course content (>=12 lessons)          | in progress | delegated to a background content agent, instructed to verify current TOEFL format/scoring via web search rather than relying on training-data memory alone                                                                                                                                                                                                                                |
| P6.4 | GRE course content (>=12 lessons)                | in progress | delegated to a background content agent against the IELTS reference + schema                                                                                                                                                                                                                                                                                                               |
...
| P6.8 | Tests                                            | in progress | Infra fully tested: `tests/unit/exam-prep-diagnostic.test.ts` + 4 integration test files (24 tests) + `tests/e2e/exam-practice.spec.ts` (6 tests, real Chromium run, all passing) covering the IELTS course end-to-end; PTE/TOEFL/GRE still need the same verification once integrated                                                                                                     |
