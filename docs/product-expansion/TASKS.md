...
remaining Phase 7 technical-course content and all four hit the account's Agent-tool monthly spend
limit (a hard infra constraint, confirmed to be specific to spawning new Agent subprocesses, not to
