...
export const ieltsInterviewQuestions: InterviewQuestionInput[] = [
  ...
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "Does IELTS require a minimum score in every individual section, or only an overall band?",
    answer:
    ...
    difficulty: "intermediate",
    commonMistake:
      "Assuming an overall band requirement automatically means there's no section-level minimum, without checking the specific requirement.",
    lastReviewed: "2026-08-07",
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "How long is IELTS Speaking, and can it be on a different day from the other sections?",
    answer:
  ...
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "Roughly how should you divide your time when studying for IELTS if you don't know your weakest section?",
    answer:
  ...
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "Where should you go to confirm current IELTS fees, test dates, and registration details?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Once. There is no replay, which is why previewing questions before the audio starts matters so much.",
    category: "Listening",
    difficulty: "beginner",
    lastReviewed: "2026-08-07",
  },
  ...
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "If a completion question says 'no more than two words,' and you write three words with correct content, do you get the mark?",
    answer:
    ...
    difficulty: "intermediate",
    commonMistake:
      "Treating word-limit instructions as a soft suggestion rather than a strict rule.",
    lastReviewed: "2026-08-07",
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "A speaker says 'the workshop starts at 9... actually, we moved it to 9:30.' Which time is the correct answer?",
    answer:
  ...
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "A multiple choice question says 'Choose TWO letters.' What happens if you only select one correct answer?",
    answer:
  ...
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "What is a reliable strategy for matching questions where you must assign speakers or topics to categories?",
    answer:
  ...
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "How much time is given for IELTS Reading, and is there extra transfer time like Listening has?",
    answer:
      "60 minutes total, with no extra transfer time -- unlike Listening, which has additional transfer time.",
    category: "Reading",
    difficulty: "beginner",
    lastReviewed: "2026-08-07",
  },
  {
    ...
    difficulty: "intermediate",
    commonMistake:
      "Treating 'Not Given' as equivalent to 'False' instead of recognizing it means the passage never addresses the claim.",
    lastReviewed: "2026-08-07",
  },
  {
  ...
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "If you can't answer a difficult Reading question after a reasonable attempt, what should you do?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Not always -- sometimes it's a transition sentence instead. Read enough of the paragraph to be sure of its main idea before deciding.",
    category: "Reading",
    difficulty: "advanced",
    lastReviewed: "2026-08-07",
  },
  {
    ...
    answer:
      "Everyday sources like notices, advertisements, and workplace documents, rather than academic material.",
    category: "Reading",
    difficulty: "beginner",
    lastReviewed: "2026-08-07",
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "Should you answer a Reading question based on your own outside knowledge of the topic?",
    answer:
      "No -- answer strictly based on what the passage itself states, not on general knowledge you may already have about the subject.",
    category: "Reading",
    difficulty: "intermediate",
    lastReviewed: "2026-08-07",
  },
  ...
  // --- Writing (10) ---
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "What is the minimum word count for Academic Writing Task 1, and roughly how long should you spend on it?",
  ...
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "What is the single most commonly missed element in a strong Academic Task 1 response?",
    answer:
    ...
    difficulty: "intermediate",
    commonMistake:
      "Listing every number in the chart without ever stepping back to state the data's main story.",
    lastReviewed: "2026-08-07",
  },
  {
    ...
    answer:
      "No -- Task 1 is purely objective description. You never argue for or against anything in this task.",
    category: "Writing",
    difficulty: "beginner",
    lastReviewed: "2026-08-07",
  },
  ...
  },
  {
    ...
    answer:
      "At least 250 words, in about 40 minutes -- roughly twice the weight of Task 1 toward your overall Writing band.",
    category: "Writing",
    difficulty: "beginner",
    lastReviewed: "2026-08-07",
  },
  ...
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "Is it better to cover many shallow points in a Task 2 body paragraph, or fewer ideas developed thoroughly?",
    answer:
      "Fewer ideas developed thoroughly with a specific example, rather than listing many shallow points.",
    category: "Writing",
    difficulty: "advanced",
    lastReviewed: "2026-08-07",
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "Can VisaSparkSchools's self-review Writing tool give you an official Writing band score?",
    answer:
      "No -- it's a self-assessment tool scored against a rubric checklist, never a claimed AI or official score.",
    category: "Writing",
    difficulty: "beginner",
    lastReviewed: "2026-08-07",
  },
  ...
  // --- Speaking (8) ---
  {
    ...
    answer:
      "Familiar, everyday topics (home, work/study, hobbies, hometown), lasting about 4-5 minutes -- essentially a warm-up.",
    category: "Speaking",
    difficulty: "beginner",
    lastReviewed: "2026-08-07",
  },
  {
    ...
    difficulty: "beginner",
    commonMistake:
      "Answering with a single word, or reciting an obviously memorized, generic response.",
    lastReviewed: "2026-08-07",
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "How much preparation time do you get before Speaking Part 2, and what should you do with it?",
    answer:
  ...
  },
  {
    ...
    answer:
      "1-2 minutes, ideally close to the full time -- addressing every bullet point with a concrete example usually provides enough material.",
    category: "Speaking",
    difficulty: "intermediate",
    lastReviewed: "2026-08-07",
  },
  ...
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "Which two of the four Speaking criteria tend to matter most in Part 1's simpler topics?",
    answer:
      "Fluency and Coherence, and Lexical Resource -- since Part 1's topics and required grammar are relatively simple.",
    category: "Speaking",
    difficulty: "advanced",
    lastReviewed: "2026-08-07",
  },
  {
    ...
    courseSlug: "ielts-preparation",
    question:
      "Does VisaSparkSchools's Speaking self-review tool record and upload your voice for grading?",
    answer:
